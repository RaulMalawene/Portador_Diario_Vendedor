...
<template>
  <div class="toolbar">
    <span class="toolbar__search">
      ...
      <input v-model="search" type="text" placeholder="Pesquisar por nome ou SKU..." />
    </span>

    <div class="toolbar__filters">
      <label class="toolbar__filter-label" for="products-status-filter">Filtrar por:</label>
      <div class="select">
        <select id="products-status-filter" v-model="status">
